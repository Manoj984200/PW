...
app.use(express.json()); // this is added to parse the incoming request body in json format. this is middleware function which is used to parse the incoming request body in json format. this middleware function is added in server1.js file before registering the router object so that it can parse the incoming request body in json format for all the api's defined in user.router.js file. we can also use this middleware function in user.router.js file to parse the incoming request body in json format for specific api's defined in user.router.js file. we can also use this middleware function in controller functions to parse the incoming request body in json format for specific api's defined in controller functions. we can also use this middleware function in any other file to parse the incoming request body in json format for specific api's defined in that file.
// Register Router
